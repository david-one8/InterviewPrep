...
import { Mic, MicOff, Square, Play, Loader, Video } from 'lucide-react';
...
const RecordAnswerSection = ({mockInterviewQuestions, activeQuestionIndex, interviewData}) => {
    ...
    },[isRecording, userAnswer, mockInterviewQuestions, activeQuestionIndex, interviewData, user, setResults]);
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div className="mb-6">
            ...
            <p className="text-gray-600 text-sm mt-1">
                Speak clearly and take your time. Your response will be automatically transcribed.
            </p>
        </div>
